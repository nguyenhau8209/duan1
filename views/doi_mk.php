    ...
    <div class="flex flex-col lg:flex-row w-10/12 lg:w-8/12 bg-white mx-auto shadow-lg overflow-hidden">
      ...
      <div class="w-full lg:w-1/2 py-16 px-12">
        <div class="flex justify-around pb-3 cursor-pointer border-b-2  ">
          <h2 class="font-bold text-lg text-[#002D74] border-b-2 border-[#F10000]">Đổi mật khẩu</h2>

        </div>

        <form action="?act=update_password" method="POST">
          <div class="mt-8">
            <p> Nhập mật khẩu mới<span class="text-red-500">*</span> </p>
            <input type="password" placeholder="Mật khẩu" name="password" class="border border-gray-400 py-1 px-2 mt-2 rounded-md h-[40px] w-full">
            <?php
          ...
          <div class="mt-8">
            ...
            <input type="password" placeholder="Nhập lại Mật khẩu" name="Confirm" class="border border-gray-400 py-1 px-2 mt-2 rounded-md h-[40px] w-full">
