    ...
    <div class="col-xl-4">
      <div class="card">
        <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
          <img src='layout/images/avatas/khavt.png' alt='Profile' class='rounded-circle'>
        ...
        <div class="card-body pt-3">
          ...
          <div class="tab-content pt-2">
            ...
            <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
              ...
              <!-- Profile Edit Form -->
              <form action="?act=edit_customer" id="profileForm" enctype="multipart/form-data" method="post">
                <div class="row mb-3">
                  <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Full Name</label>
                  <div class="col-md-8 col-lg-9">
                    <input type="hidden" name="id_customer" value="<?=$customer['id']?>">
                    <input name="fullName" type="text" class="form-control" id="fullName" value="<?=$customer['fullname']?>">
                  </div>
                </div>
                <div class="row mb-3">
