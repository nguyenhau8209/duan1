  ...
  <main>
    <div class="container">
      <section class="section error-404 min-vh-100 d-flex flex-column align-items-center justify-content-center">
        <h1>404</h1>
        <h2>Vui lòng đăng nhập để sử dụng chức năng quản trị </h2>
        <a class="btn" href="index.php?act=login_admin">Back to login</a>
        <img src="views/admin/assets/img/not-found.svg" class="img-fluid py-5" alt="Page Not Found">
        <div class="credits">
