...
<main class="text-center my-10">
    ...
    <div class="">
         <h1 class="font-[600] text-[22px] text-center py-[34px] leading-[31px] text-[#4D4D4D]">ĐỒ NỮ</h1>
...
$(document).ready(function(){
    ...
    function filter_data()
    {
        ...
        $.ajax({
            url:"controller/filter_woman.php",
            method:"POST",
            data:{action:action,brand:brand,name_az:name_az,name_za:name_za,pr_new:pr_new,price_increase:pr_increase,reduced_price:reduced_pr},
